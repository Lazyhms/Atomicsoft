...
internal sealed class SecurityRequirementsOperationFilter(string authenticationScheme, OpenApiSecurityScheme openApiSecurityScheme) : IOperationAsyncFilter
{
